...
public class HotelAdmin
{
    ...
    public APIGatewayProxyResponse TestHandler(APIGatewayProxyRequest request)
    {

        var databaseRecord = request;
    ...
    public async Task<APIGatewayProxyResponse> AddHotel(APIGatewayProxyRequest request, ILambdaContext context)
    {
        ...
        var bodyContent = request.IsBase64Encoded
            ...
            : Encoding.UTF8.GetBytes(string.IsNullOrEmpty(request.Body) ? "" : request.Body);
